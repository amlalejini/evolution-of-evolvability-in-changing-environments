...
## Entropy of unique 1-step phenotypes
...
# envs <- ls2_cooccur_data$env_condition
# for (env in envs) {
#   temp_data <- filter(ls2_cooccur_data, COPY_MUT_PROB=="0.001" & env_condition==env)
#   ggplot(
#       temp_data,
#       aes(
#         x=task_1_id,
...
#   ggsave(
#     paste0(working_directory, "plots/", "matrix_", env, "_001.pdf")
#   )
# }
```